...
type RationaleOptions = RationaleObject & {
 ...
 * @param {RationaleObject} requestBlocked - The RationaleObject to display when the user is blocked permission.
 * @param {PermissionsOptions} options - for initial configuration of hooks.
...
export function useNotificationPermissions(
  requestBlocked: RationaleObject & {
    buttonNeutral?: string;
  },
  options: PermissionsOptions = {},
  onGranted: () => void = () => {}
